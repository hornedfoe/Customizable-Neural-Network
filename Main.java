...
public class Main {
    ...
    private static double[] function(double[] x) {
        ...
        return new double[] { (v * v + v + v) * (v < 0 ? -1 : 1) };
    }
    ...
    public static void main(String[] args) throws IllegalAccessException, IOException {
        ...
        double lower_bound = 0d, upper_bound = 200d;

        Random rand = new Random();

        Integer[] structure = { feature, 20, 20, 20, 20, output };
        ...
        Runnable plotTask = () -> {
            try {
                ...
                System.err.println("Error in plot task: " + e.getMessage());
            }
        };
